                ...
                <div class="border-0 mb-4">
                    <div
                        ...
                        <a href="{{ route('admin.products.create') }}" class="btn btn-primary py-2 px-4">
                            <i class="icofont-plus-circle me-2"></i>
                            Add Product
                        </a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($product->main_image)
                                                        <img src="{{ asset($product->main_image) }}"
                                                            alt="{{ $product->name }}" class="rounded" width="55"
                                                            height="55" style="object-fit: cover;">
                                                    @else
                                                        <div
                                                            class="avatar lg rounded bg-light d-flex align-items-center justify-content-center">
                                                ...
                                                <td>
                                                    ...
                                                    @php
                                                        ...
                                                        $regularPrice = (float) ($product->price_ngn ?? 0);

                                                        $salePrice = (float) ($product->sale_price_ngn ?? 0);
                                                ...
                                                <td>
                                                    ...
                                                    <span
                                                        class="badge {{ $product->stock_status === 'in_stock' ? 'bg-success' : 'bg-danger' }}">
