                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text"
                                   ...
                                   placeholder="Springcrest Support">
                        </div>
                        ...
                        <div class="col-md-12 mb-0">
                            ...
                            <textarea name="support_message_body"
                                      rows="4"
                                      class="form-control"
                                      placeholder="Thank you for visiting Springcrest Trading. How can we help you today?">{{ old('support_message_body', $setting->support_message_body) }}</textarea>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="meta_keywords"
                                  rows="3"
                                  class="form-control">{{ old('meta_keywords', $setting->meta_keywords) }}</textarea>
                    </div>
