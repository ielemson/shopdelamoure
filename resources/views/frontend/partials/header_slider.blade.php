    ...
    <div class="slick-slider hero hero-header-01"
            ...
            <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
                <div class="hero-content text-start">
                    <div data-animate="fadeInDown">
                        <p class="text-body-emphasis mb-8 text-uppercase fw-semibold fs-15px">Signature Fragrances</p>
                        <h1 class="mb-7 hero-title">A Scent That<br>Speaks For You</h1>
                        <p class="hero-desc text-body-calculate fs-18px mb-11">Discover beautifully crafted fragrances
                            designed to leave a lasting impression wherever you go.</p>
                    </div>
                    <a href="javascript:void(0);" data-animate="fadeInUp"
                        class="btn btn-lg btn-dark btn-hover-bg-primary btn-hover-border-primary">Shop Now</a>
                </div>
            </div>
        ...
        <div class="vh-100 d-flex align-items-center">
            <div class="z-index-2 container container-xxl py-21 pt-xl-10 pb-xl-11">
                <div class="hero-content text-start">
                    <div data-animate="fadeInDown">
                        <p class="text-body-emphasis mb-8 text-uppercase fw-semibold fs-15px">Home Fragrance</p>
                        <h1 class="mb-7 hero-title">Transform Every<br>Space With Scent</h1>
                        <p class="hero-desc text-body-calculate fs-18px mb-11">Create a warm and inviting atmosphere
                            with our collection of diffusers, room sprays, candles, and essential oils.</p>
                    </div>
                    <a href="javascript:void(0);" data-animate="fadeInUp"
                        class="btn btn-lg btn-dark btn-hover-bg-primary btn-hover-border-primary">Explore Collection</a>
                </div>
            </div>
            <div class="lazy-bg bg-overlay position-absolute z-index-1 w-100 h-100 light-mode-img"
